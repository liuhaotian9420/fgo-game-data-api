...
class NiceVoiceCond(BaseModel):
    ...
    eventId: int = Field(0, title="Event ID", description="Event ID.")
...
class NiceMasterMission(BaseModelORJson):
    ...
    endedAt: int
    closedAt: int
    script: NiceMasterMissionScript = NiceMasterMissionScript()
    missions: list[NiceEventMission]
...
class EnemyLimit(BaseModelORJson):
    limitCount: int = 0
    imageLimitCount: int = 0
    dispLimitCount: int = 0
    commandCardLimitCount: int = 0
    iconLimitCount: int = 0
    portraitLimitCount: int = 0
    battleVoice: int = 0
    exceedCount: int = 0
...
class NiceSpot(BaseModel):
    ...
    originalName: str
    image: Optional[HttpUrl] = None
    x: Annotated[Decimal, DecimalSerializer] = Decimal()
    y: Annotated[Decimal, DecimalSerializer] = Decimal()
    imageOfsX: int = 0
    imageOfsY: int = 0
    nameOfsX: int = 0
    nameOfsY: int = 0
...
class NiceFuncTypeDetail(BaseModelORJson):
    ...
    ignoreValueUp: bool
    individuality: list[NiceTrait] | None = []
